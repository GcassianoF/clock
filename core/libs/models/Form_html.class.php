...
*/
class Form_html extends DAO
{
	/* Default definitions */
    private $Form = "<form";
    private $Attr = array('name'=>'default_form','action'=>'','method'=>'post','enctype'=>'multipart/form-data','class'=>'form-vertical');
	/* Default constructor */
    ...
    function form_START($class='padded', $innerHTML_BEFORE=NULL, $innerHTML_AFTER=NULL)
    {
    ...
    function form_END($innerHTML_BEFORE=NULL, $innerHTML_AFTER=NULL)
    {
        echo $innerHTML_BEFORE;
        echo '</div>';
        echo $innerHTML_AFTER;
    ...
    function form_actions_Start($class='form-actions', $innerHTML_BEFORE=NULL, $innerHTML_AFTER=NULL)
    {
        echo $innerHTML_BEFORE;
        echo '<div class="'.$class.'" >';
        echo $innerHTML_AFTER;
    ...
    function form_actions_End($innerHTML_BEFORE=NULL, $innerHTML_AFTER=NULL)
    {
        echo $innerHTML_BEFORE;
        echo '</div>';
        echo $innerHTML_AFTER;
    ...
    function InputGroup_Start($label, $innerHTML_BEFORE=NULL, $innerHTML_AFTER=NULL)
    {
        echo $innerHTML_BEFORE;
    ...
    function InputGroup_End($innerHTML_BEFORE=NULL, $innerHTML_AFTER=NULL)
    {
        echo $innerHTML_BEFORE;
        echo '</div></div>';
        echo $innerHTML_AFTER;
